...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-100/50 flex flex-col justify-center items-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl shadow-orange-900/5 border border-white/50 backdrop-blur-sm p-8 relative z-10 my-8">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-500 text-sm text-center">Start generating video ads for your business</p>
        </div>
        ...
        >
          ...
          <svg className="w-5 h-5" viewBox="0 0 24 24">
            ...
            <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.47 5.38 5.84 8.22l2.18 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335" />
          </svg>
        ...
        <p className="mt-6 text-center text-sm text-gray-600">
          ...
          <Link href="/login" className="font-bold text-brand-orange hover:text-brand-orange-dark">Sign in</Link>
        </p>
      </div>
    </div>
  );
